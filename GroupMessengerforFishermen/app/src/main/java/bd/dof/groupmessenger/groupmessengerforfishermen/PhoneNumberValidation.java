                ...
                public void onClick(View v) {
                    ...
                    if (userphonenumber.getText().toString().length() > 0 && userphonenumber.getText().toString().length()==11) {
                       ...
                       final String phonenumber = userphonenumber.getText().toString().trim();
                        ...
                        nSystemInfo.setUserID(Integer.parseInt("1"));
                        nSystemInfo.setUserName("User");
                        nSystemInfo.setUserPhoneNumber(phonenumber);
                        nSystemInfo.setUserDivisionID("10");
                        nSystemInfo.setUserDistrictID("78");
                        nSystemInfo.setUserUpazillaID("66");
