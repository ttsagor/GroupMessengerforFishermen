...
public class PhoneNumberValidation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("sagor "+cSystemInfo.getUserID()+" "+cSystemInfo.getDataLoaded()+" "+cSystemInfo.getUserName());
        ...
        else
        {
            ...
            phonenumberconfirm.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (userphonenumber.getText().toString().length() > 0 && userphonenumber.getText().toString().length()==11) {
                       ...
                       final String phonenumber = userphonenumber.getText().toString().trim();
                        ...
                        String url ="http://digital-phonebook.com/groupmessenger/phone_number_validation.php?phone_number="+phonenumber;
                        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                                    ...
                                    public void onResponse(String response) {
                                        ...
                                        try {
                                            ...
                                            if(Integer.parseInt(status)==1)
                                            {
                                                ...
                                                nSystemInfo.setUserID(Integer.parseInt(jb.get("user_id").toString()));
                                                nSystemInfo.setUserName(jb.get("user_name_bng").toString());
                                                nSystemInfo.setUserPhoneNumber(phonenumber);
                                                nSystemInfo.setUserDivisionID(jb.get("division_id").toString());
                                                nSystemInfo.setUserDistrictID(jb.get("district_id").toString());
                                                nSystemInfo.setUserUpazillaID(jb.get("upazilla_id").toString());
                                                nSystemInfo.setDataLoaded(1);

                                                final String key = rendomNumberGenerator("abcdefghijklmnopqrstuvwxyz123456789");
                                                SmsManager smsManager = SmsManager.getDefault();
                                                smsManager.sendTextMessage(phonenumber, null, "Welcome to Group Messenger.Your access key is : " + key, null, null);
                                                            ...
                                                            while (true) {
                                                                ...
                                                                if (cursor.moveToFirst()) { // must check the result to prevent exception
                                                                    do {
                                                                        ...
                                                                        String inboxKey = "";
                                                                        if (msgData.contains("Welcome to Group Messenger.Your access key is : ")) {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                ...
                                alertChecking.cancel();
                                AlertDialog.Builder dlgAlert = new AlertDialog.Builder(mContext);
                                dlgAlert.setMessage("ইন্টারনেট সংযোগ চালু করুন");
                                dlgAlert.setTitle("");
                                dlgAlert.setPositiveButton("বন্ধ করুন", null);
                                dlgAlert.setCancelable(false);
