...
public class AgeWiseFood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(AgeWiseFood.this, HomeScreenActivity.class));
            }
        });

        EditText title = findViewById(R.id.title);
        title.setText("মাছের খাদ্য প্রয়োগ");
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_login:
                        if (log.equals("true")) {
                            ...
                            editor.apply();
                            startActivity(new Intent(AgeWiseFood.this, SplashScreenActivity.class));

                        } else {
                            startActivity(new Intent(AgeWiseFood.this, LoginActivity.class));
                        }
                        break;

                    case R.id.menu_sotorkota:
                        startActivity(new Intent(AgeWiseFood.this, SotorkotaActivity.class));
                        break;
                    case R.id.menu_profile:
                        startActivity(new Intent(AgeWiseFood.this, ProfileActivity.class));
                        break;
                    case R.id.menu_beboharbidi:
                        startActivity(new Intent(AgeWiseFood.this, BaboharbidiActivity.class));
                        break;

                    case R.id.menu_somoshajomadin:
                        startActivity(new Intent(AgeWiseFood.this, ComingSoonActivity.class));
                        break;
                }
                return false;
            }
