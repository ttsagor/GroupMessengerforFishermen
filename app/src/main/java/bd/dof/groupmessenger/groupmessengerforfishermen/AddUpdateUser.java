                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_login:
                        if (log.equals("true")) {
                            ...
                            editor.apply();
                            startActivity(new Intent(AddUpdateUser.this, SplashScreenActivity.class));

                        } else {
                            startActivity(new Intent(AddUpdateUser.this, LoginActivity.class));
                        }
                        break;

                    case R.id.menu_sotorkota:
                        startActivity(new Intent(AddUpdateUser.this, SotorkotaActivity.class));
                        break;
                    case R.id.menu_profile:
                        startActivity(new Intent(AddUpdateUser.this, ProfileActivity.class));
                        break;
                    case R.id.menu_beboharbidi:
                        startActivity(new Intent(AddUpdateUser.this, BaboharbidiActivity.class));
                        break;

                    case R.id.menu_somoshajomadin:
                        startActivity(new Intent(AddUpdateUser.this, ComingSoonActivity.class));
                        break;
                }
                return false;
            }
