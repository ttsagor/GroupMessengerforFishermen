    ...
    private void bottomNavigationHandler() {
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(ComingSoonActivity.this, HomeScreenActivity.class));
            }
        });
                ...
                switch (item.getItemId()) {
                    ...
                    case R.id.menu_login:
                        if (log.equals("true")) {
                            ...
                            editor.apply();
                            startActivity(new Intent(ComingSoonActivity.this, SplashScreenActivity.class));
                    ...
                    case R.id.menu_sotorkota:
                        startActivity(new Intent(ComingSoonActivity.this, SotorkotaActivity.class));
                        break;
                    case R.id.menu_profile:
                        startActivity(new Intent(ComingSoonActivity.this, ProfileActivity.class));
                        break;
                    case R.id.menu_beboharbidi:
                        startActivity(new Intent(ComingSoonActivity.this, BaboharbidiActivity.class));
                        break;
