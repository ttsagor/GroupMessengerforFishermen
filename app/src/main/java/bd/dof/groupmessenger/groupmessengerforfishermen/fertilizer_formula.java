...
public class fertilizer_formula extends AppCompatActivity {
    ...
    TextInputEditText fertilizer_length, fertilizer_width, fertilizer_qunatity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fertilizer_length = findViewById(R.id.fertilizer_length);
        fertilizer_width = findViewById(R.id.fertilizer_width);
        fertilizer_qunatity = findViewById(R.id.fertilizer_qunatity);
        ...
        findViewById(R.id.back).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(fertilizer_formula.this, HomeScreenActivity.class));
            }
        });
